...
async def game_loop():
    ...
    while True:
        ...
        crash_history.insert(0, state["x"])
        crash_history = crash_history[:10]
        save(CRASH_FILE, crash_history)
