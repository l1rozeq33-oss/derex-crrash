...
async def start(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    kb = InlineKeyboardMarkup([[
        InlineKeyboardButton("🚀 Играть в Crash", web_app=WebAppInfo(url=WEBAPP_URL))
    ]])
...
async def game_loop():
    while True:
        ...
        GAME["state"] = "flying"
        GAME["timer"] = 0
        GAME["crash"] = round(random.uniform(1.0, 6.5), 2)
...
<body>
<h2 style="color:white;text-align:center">MiniApp работает</h2>
</body>
</html>
"""
